...
He desarrollado experiencias en docencia artística, mediación cultural, diseño de propuestas educativas y conducción de talleres de artes visuales.

Mi trayectoria incluye:

- Enseñanza de artes visuales en instituciones educativas.
- Formación artística en educación superior tecnológica.
- Diseño y desarrollo de talleres artísticos.
- Mediación cultural en espacios museales.
- Elaboración de proyectos pedagógicos y culturales.

Me desempeñé como mediadora cultural en el Museo de Arte de Lima durante el periodo 2022–2025 y actualmente desarrollo talleres artísticos en SENATI.

## 🌱 Temas que me interesan

- Educación artística.
- Artes visuales.
- Autorrepresentación y autorretrato artístico.
- Procesos creativos e introspección.
- Identidad y autoafirmación cultural.
- Mediación cultural.
- Arte, memoria y territorio.
- Docencia universitaria.
- Investigación cualitativa.

## 📚 Proyectos académicos actuales

Actualmente desarrollo trabajos académicos relacionados con el autorretrato como herramienta de introspección y construcción de identidad en estudiantes de artes visuales.

También elaboro una propuesta pedagógica basada en la autorrepresentación artística para fortalecer la autoafirmación cultural en estudiantes de educación secundaria del valle de Calango, Perú.

## 💻 Mi aprendizaje en Debug Colectiva

Mi participación en Debug Colectiva me permite fortalecer progresivamente mis conocimientos sobre:

- Uso de GitHub para organizar proyectos.
- Creación y administración de repositorios.
- Documentación de procesos académicos.
...
- Recursos sobre educación artística.
- Materiales pedagógicos.
- Experiencias de mediación cultural.
- Presentaciones y actividades formativas.
- Ejercicios metodológicos.
- Registros de procesos artísticos.
- Aprendizajes relacionados con herramientas digitales.

## 🤝 Intereses de colaboración

Me interesa conocer y colaborar con personas y proyectos vinculados con:
